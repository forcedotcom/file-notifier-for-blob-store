...
az keyvault set-policy -n $KEY_VAULT_NAME --resource-group $RESOURCE_GROUP --key-permissions get list sign import --secret-permissions get list --object-id $appPrincipalIdentity

Write-Host "Step 11/14 : Successfully set key and secret permissions to KeyVault with name ${KEY_VAULT_NAME}"
"Step 11/14 : Successfully set key and secret permissions to KeyVault with name ${KEY_VAULT_NAME}" | Out-File -FilePath $log_filename -Append
...
Write-Host "Step 12/14 : Successfully set config settings to function app with name ${APP_NAME}"
"Step 12/14 : Successfully set config settings to function app with name ${APP_NAME}" | Out-File -FilePath $log_filename -Append
...
Write-Host  "Step 13/14 : Successfully deplopyed function app with name ${APP_NAME}"
"Step 13/14 : Successfully deplopyed function app with name ${APP_NAME}" | Out-File -FilePath $log_filename -Append
