...
def _get_token_and_instance_url():
    ...
    if cache.get('cdp_access_token') and current_epoch < cache.get('cdp_access_token').get('ttl'):
        ...
        print('Cache miss! - JWT: ' + str(jwt_token))
        ...
        print('Response core access token - ' + str(core_response.json()))
        ...
        print('Response cdp access token - ' + str(cdp_response.json()))
...
def get_secret():
    secret_name = "unstructured-brahmaputra-consumer-key"
